...
# Road-focused continuation from the frozen deployment candidate.  This is a
# new checkpoint family so its direct parent and role-specific critic contract
# cannot be confused with the historical Vehicle-only format-v9 lineage.
ROAD_FOCUSED_CANDIDATE_ID = "cov2x_g30_road_focused_extension_v1"
ROAD_FOCUSED_CHECKPOINT_FORMAT_VERSION = 10
ROAD_FOCUSED_PARENT_CANDIDATE_ID = TEMPORARY_SPEED_CAP_CANDIDATE_ID
ROAD_FOCUSED_PARENT_CHECKPOINT_FORMAT_VERSION = (
    TEMPORARY_SPEED_CAP_CHECKPOINT_FORMAT_VERSION
)
ROAD_FOCUSED_PARENT_CHECKPOINT_GENERATION = 24
...
ROAD_FOCUSED_CRITIC_LINEAGE = (
    "fresh_role_intersection_context_road_global_reward_v1"
)
ROAD_FOCUSED_REWARD_SEMANTICS = "network_time_loss_rate_v1"
ROAD_FOCUSED_ACTOR_UPDATE_SCHEDULE_ID = "road_only_full_authority_x8_v1"
ROAD_FOCUSED_FROZEN_ACTOR_ROLES = ("cloud", "vehicle")
ROAD_FOCUSED_ACTOR_UPDATES = 8
