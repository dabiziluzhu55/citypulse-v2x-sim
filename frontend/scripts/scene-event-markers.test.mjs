...
test('3D scene keeps every non-cancelled runtime red marker and preserves legacy construction markers', async () => {
  ...
  assert.match(source, /projectMarkerToContainer\(marker\.id/)
  ...
  assert.match(markerSource, /new mapvthree\.DOMOverlay/)
  assert.match(markerSource, /scene-event-map-anchor/)
