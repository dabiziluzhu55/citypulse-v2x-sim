...
CARLA_ROOT = os.environ.get(
    "CARLA_ROOT", "/home/kemove/devdata1/zrl/software/CARLA_0.9.16"
)
COSIM_SUMO_DIR = os.path.join(CARLA_ROOT, "Co-Simulation", "Sumo")
if COSIM_SUMO_DIR not in sys.path:
    sys.path.insert(0, COSIM_SUMO_DIR)
